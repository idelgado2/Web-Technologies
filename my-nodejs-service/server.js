...
app.get('/', function(req, res){
    res.send('Hello from server, this is serving my HW8');
})

app.get('/hwios', function(req, res){
    //res.send(req.query);
    var jsonData = JSON.parse(JSON.stringify(req.query)); //request body is the send search in json structure -- street, city, state
...
app.post('/forecast_swiftLocation', function(req, res){
